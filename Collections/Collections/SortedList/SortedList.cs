namespace Collections.SortedList
{
    ...
    /// کلیدمون از هر نوعی میتونه باشه ولی باید قابلیت مرتب سازی داشته باشه
    /// در نهایت وقتی برامون ترتیب قرارگیری عناصر اهمیت داشته باشه و مرتب باشه از سورتد لیست استفاده میکنیم
    /// </summary> 
    #endregion
    #region SortedList
